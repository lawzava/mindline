...
// Include Phase 6 modules
mod crypto;
use crypto::{with_encryption_manager, EncryptedData};

mod storage;
use storage::{StoredMessage, StoredRoom, StorageConfig};

mod performance;
use performance::{with_performance_monitor, MetricCategory, PerformanceSummary};
