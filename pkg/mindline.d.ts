...
export function validate_room_id(room_id: string): string | undefined;
export function validate_username(username: string): string | undefined;
export function validate_message(message: string): string | undefined;
